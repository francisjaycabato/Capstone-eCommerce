...
-- Password: Password1!
INSERT INTO `products` (`PRODUCT_ID`, `PRODUCT_NAME`, `STORE_ID`, `PRODUCT_PRICE`, `DESCRIPTION`, `COLOR`, `SIZE`) VALUES
(000001, 'Shirt', 6, 24.99, 'Crafted from high-quality cotton, it offers a comfortable and breathable feel. The shirt boasts a sleek and modern design with a tailored fit, making it suitable for various occasions – from casual outings to more formal events. The black hue adds a touch of sophistication and allows for easy pairing with different bottoms and accessories. Whether worn solo or layered, this black shirt effortlessly combines style and comfort for a chic and fashionable look.', 'Select Color', 'Select Size'),
