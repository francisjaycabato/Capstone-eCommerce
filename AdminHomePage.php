...
if(isset($_GET['success']) && $_GET['success'] == 1){
    ...
    echo "<script>alert('New User Registration Success!');</script>";
        ...
        <div class="modal-content">
            ...
            <form class="login-form" action="AdminValidation.php" id="signup" method="post">
                ...
                <div id="acctype">
                    ...
                    <input type="radio" name="accountType" id="notAdmin" value = "0" />

                    <label for="isVendor">Vendor</label>
                    <input type="radio" name="accountType" id="isVendor" value = "1" />    

                    <label for="isAdmin">Administrator</label>
                    <input type="radio" name="accountType" id="isAdmin" value = "2" />      
